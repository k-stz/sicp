...
;; tracing thorugh all the calls when issuing (magnitude z)
...
;; This magnitude operation isn't the selctor yet, its the complex-arithmetic
;; selector (see Ben's and Alyssa's implementation in Section 2.4.3).
;; Those call an apply-generic interanally:
